...
The Student Lifecycle defines how students progress through Bhavya Foundation. Every transition is verified through evidence, skills, projects, portfolio, contribution, and reflection.

## The Lifecycle

```
Visitor
  ↓ [Explore platform, read about mission]
Applicant
  ↓ [Submit application, demonstrate curiosity]
Student
  ↓ [Complete lessons, build projects]
Builder
  ↓ [Create original projects, solve real problems]
Contributor
  ↓ [Contribute to open source, help community]
Mentor
  ↓ [Guide students, review projects, teach]
Instructor
  ↓ [Create courses, design curriculum]
Research Fellow
  ↓ [Conduct research, publish findings]
Alumni
  ↓ [Stay connected, give back]
Community Leader
  → [Lead chapters, organize events, build ecosystem]
```
...
- Portfolio with verified impact
