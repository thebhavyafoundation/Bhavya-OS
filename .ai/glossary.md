...
Architecture Decision Record. Immutable record of architectural decisions, stored in `docs/adr/`.

### AI Gateway

Provider-agnostic abstraction layer for LLM access. Defined in RFC-0003 and ADR-008.
