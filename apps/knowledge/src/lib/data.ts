...
export function getDocumentsByCategory(category: DocumentCategory): KnowledgeDocument[] {
...
export function getKnowledgeGraph(): GraphNode[] {
  return readJSON<{ nodes: GraphNode[] }>("registry/knowledge-graph.json", { nodes: [] }).nodes;
}
...
const DEFAULT_COLLECTIONS: Collection[] = [
  {
    ...
    description: "Core governing documents, decision records, and institutional policies",
    documentIds: [],
    category: "governance",
    created: "2026-07-15",
  },
  {
    ...
    description: "Technical standards, architecture rules, and development practices",
    documentIds: [],
    category: "standard",
    created: "2026-07-15",
  },
  {
    ...
    description: "Architectural Decision Records documenting key technical choices",
    documentIds: [],
    category: "adr",
    created: "2026-07-15",
  },
  {
    id: "technical-rfcs",
    name: "Technical RFCs",
    description: "Request for Comments — technical proposals and specifications",
    documentIds: [],
    category: "rfc",
    created: "2026-07-20",
  },
  ...
  },
  {
    ...
    description: "Organizational policies for governance, ethics, and operations",
    documentIds: [],
    category: "policy",
    created: "2026-07-15",
  },
...
export function getKnowledgeStats(): KnowledgeStats {
  ...
  const documentsByCategory: Record<DocumentCategory, number> = {
    governance: 0, policy: 0, standard: 0, adr: 0, rfc: 0,
    release: 0, research: 0, report: 0, project: 0, content: 0, financial: 0,
  };
