...
const releases = [
  {
    ...
    date: "2026-07-24",
    status: "rc",
    notes: "Platform RC with governance policy, release train, ADR-009",
  },
  {
    tag: "v1.0.0-rc1",
    date: "2026-07-24",
    status: "rc",
    notes:
      "Platform release candidate: 3 apps, shared runtime, production infrastructure",
  },
  {
    tag: "v0.9.0-rc1",
    date: "2026-07-23",
    status: "rc",
    notes: "APP-001 frozen, website redesigned with UI/UX Pro Max",
  },
];
