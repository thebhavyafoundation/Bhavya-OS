/**
 * Bhavya Academy — Internationalization
 *
 * Multi-language support for the canonical host.
 * Migrated from apps/website/src/i18n/config.ts.
 *
 * @module i18n
 */
...
> = {
  ...
  "nav.curriculum": { "en-IN": "Curriculum", hi: "पाठ्यक्रम" },
  "hero.badge": { "en-IN": "Bhavya OS {version} Active" },
  "hero.title": {
    "en-IN":
      "Serving <span>Nature</span>,<br />Knowledge, Heritage<br />and Community.",
    hi: "प्रकृति, ज्ञान, विरासत<br />और समुदाय की सेवा",
  },
  "hero.desc": {
    "en-IN":
      "Bhavya Foundation is an institutional platform built for the long term — operating with radical transparency, governance discipline, and an enduring commitment to humanity.",
  },
  ...
  "section.pillars.desc": {
    "en-IN":
      "Click any pillar to explore its dedicated programs, live telemetry, and active field operations.",
  },
  "section.platform": { "en-IN": "Real-Time Platform" },
  "section.services": { "en-IN": "Institutional Services & Portals" },
  "footer.tagline": {
    "en-IN":
      "© 2026 Bhavya Foundation · Operating with Radical Transparency · Built on Bhavya OS v3.0",
  },
  "search.placeholder": {
    "en-IN": "Search the foundation...",
    hi: "फाउंडेशन खोजें...",
  },
  "search.button": { "en-IN": "Search", hi: "खोज" },
  "accessibility.skip": {
    "en-IN": "Skip to main content",
