...
✓ All 6 tests passed`,
  ...
  return (
    <div className="min-h-screen bg-[#0a0f0d]">
      <nav className="sticky top-0 z-50 border-b border-[#1a3a2a]/40 bg-[#0a0f0d]/80 backdrop-blur-xl">
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        ...
        >
          ...
          <p className="text-[#8a7359] text-sm leading-relaxed max-w-2xl">
            ...
            study hours using scikit-learn. Train the model, make predictions,
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#8a7359] leading-relaxed">
                ...
                learn the relationship between hours studied and scores
                achieved. Your model should be able to predict scores for new
                inputs. Evaluate using the R² metric.
              </p>
            </div>
          </div>
        </motion.div>
