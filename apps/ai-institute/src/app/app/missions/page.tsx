...
const missions = [
  {
    ...
    description: "Restoring 1000 hectares of degraded forest across India.",
    icon: TreePine,
    color: "var(--forest)",
    progress: 23,
    target: "1000 hectares",
    current: "230 hectares restored",
  ...
  },
  {
    ...
    color: "var(--earth)",
    progress: 15,
    target: "500 sites documented",
    current: "75 sites documented",
