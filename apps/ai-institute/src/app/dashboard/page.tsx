      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="border border-border-primary rounded-lg p-6 bg-bg-secondary animate-fade-in">
            ...
            >
              {completedLessons === 0 ? "Start Lesson 1" : "Continue Learning"}
            </Link>
          </div>
          ...
          <div className="border border-border-primary rounded-lg p-6 bg-bg-secondary animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                >
                  {progress.labTasksCompleted.length === module.lab.tasks.length
                    ? "✓"
                    : "🔬"}
                </span>
                <span className="text-text-secondary">{module.lab.title}</span>
              </Link>
              <Link
        ...
        <div className="space-y-6">
          ...
          <div className="border border-border-primary rounded-lg p-6 bg-bg-secondary animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <Link
                href="/projects"
                className="block w-full text-left p-3 border border-accent-blue/30 bg-accent-blue/5 rounded-md text-sm text-accent-blue hover:border-accent-blue/50 transition-colors"
              >
                🔨 Projects
              </Link>
              <Link
                href="/impact"
                className="block w-full text-left p-3 border border-accent-green/30 bg-accent-green/5 rounded-md text-sm text-accent-green hover:border-accent-green/50 transition-colors"
              >
                🌍 Impact Problems
              </Link>
              <Link
