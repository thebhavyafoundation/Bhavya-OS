        ...
        <div className="animate-pulse space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="h-32 bg-bg-tertiary/20 rounded-xl border border-border-primary/30"
              />
            ))}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 h-64 bg-bg-tertiary/15 rounded-xl border border-border-primary/20" />
