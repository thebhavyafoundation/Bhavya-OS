...
function generateKnowledgeGraph() {
  const nodes = [
    ...
    },
    {
      ...
      created: "2026-07-22",
      updated: "2026-07-22",
      links: ["ADR-0002", "agent.engineering"]
    },
    {
      id: "BAR-001",
      type: "standard",
    ...
    },
    {
      ...
      created: "2026-07-22",
      updated: "2026-07-22",
      links: ["ADR-0001", "ADR-0002", "RFC-0003"]
    }
  ];
  ...
  fs.writeFileSync(path.join(registryDir, 'knowledge-graph.json'), JSON.stringify(data, null, 2));
  console.log("✓ Knowledge Graph generated in registry/knowledge-graph.json");
}
...
function generateSearchIndex() {
  const documents = [
    {
      id: "doc-adr-0001",
      title: "ADR-0001 Architectural Decision Records Standard",
      category: "ADR",
      path: "governance/adr/ADR-0001.md",
      content: "Adopt ADR format for all significant engineering, architectural, and governance decisions.",
      tags: ["adr", "governance", "architecture"]
    },
    {
      id: "doc-adr-0002",
      title: "ADR-0002 Provider-Agnostic AI Gateway Abstraction Layer",
      category: "ADR",
      path: "governance/adr/ADR-0002.md",
      content: "Provider-agnostic AI Gateway architecture exposing generate, chat, embed, transcribe, reason endpoints.",
    ...
    },
    {
      ...
      content: "Technical RFC specifying the gateway routing pipeline, provider backends, and failover strategy.",
      tags: ["rfc", "ai", "gateway"]
    },
    {
      id: "doc-bar-0001",
      ...
      content: "Monorepo dependency rules, no circular dependencies, design system isolation.",
    ...
    },
    {
      ...
      category: "Standard",
      path: "standards/design.md",
      content: "UI design tokens, typography, visual hierarchy, color palette, accessibility WCAG AA.",
      tags: ["standard", "bdl", "design", "a11y"]
    },
    {
      id: "doc-bps-001",
      title: "BPS Bhavya Production Standards",
      category: "Standard",
      path: "standards/release.md",
      content: "CI/CD quality gates, bundle budgets, automated testing requirements, release checklists.",
  ...
  fs.writeFileSync(path.join(registryDir, 'search-index.json'), JSON.stringify(data, null, 2));
  console.log("✓ Search Index generated in registry/search-index.json");
}
