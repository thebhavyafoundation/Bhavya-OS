...
if (content.includes('"math-1-1"')) { console.log('already done'); process.exit(0); }
const block = `
  // ═══════════════════════════════════════════════════════════════════
  // MATHEMATICS FOR AI
  // ═══════════════════════════════════════════════════════════════════
...
const after = content.slice(idx + 4); // starts with "\r\n};\r\n\r\n//"
const finalContent = before + ',' + block + after;
fs.writeFileSync(path, finalContent, 'utf8');
console.log('inserted ok', finalContent.length);
